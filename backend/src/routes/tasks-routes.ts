...
router.post("/", userRegister)                          //POST /users/register: Registra usuarios con contraseñas hasheadas.
router.post("/", userLogin)                            //POST /users/login: Devuelve un token de autenticación al iniciar sesión correctamente.
